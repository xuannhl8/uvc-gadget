				    ...
				    struct video_buffer *buf)
{
	...
	createtime_testsource = (end_test.tv_sec - start_test.tv_sec) + (end_test.tv_usec - start_test.tv_usec) / 1000000.0;
	printf("Time for create framesize of TEST SOURCE: %f\n",createtime_testsource);
}
