...
{
	printf("MjpegEncoder::MjpegEncoder.\n");
				...
				unsigned int cookie)
{
	...
	printf("MjpegEncoder::EncodeBuffer.\n");
			      ...
			      uint8_t *&encoded_buffer, size_t &buffer_len)
{
	...
	printf("MjpegEncoder::encodeJPEG.\n");

	/* Show information of input source */
	...
	/* Before encoding */
	printf("Buffer length before encoding: %zu bytes\n", buffer_len);
	...
	/* After encoding */
	printf("Buffer length after encoding: %zu bytes\n", jpeg_mem_len);
...
void MjpegEncoder::encodeThread(int num)
{
	...
	printf("MjpegEncoder::encodeThread.\n");
...
void MjpegEncoder::outputThread()
{
	...
	printf("MjpegEncoder::outputThread.\n");
